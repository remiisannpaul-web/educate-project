...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="max-w-md flex flex-col justify-start h-full">
          ...
          <div className="mt-40">
            ...
            <h2 className="text-5xl font-bold text-white leading-tight mb-6">
              We&apos;re <span className="bg-blue-400 px-2">Changing</span> The
              Education System Forever.
            </h2>

            {/* Description */}
            <p className="text-lg text-white mb-8">
              Practical education that gives you all the tools you need to
      ...
      <div className="flex-1 bg-black flex flex-col"></div>
    </div>
  );
}
